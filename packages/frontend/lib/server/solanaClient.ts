...
import * as idl from "../../anchor/idl/strategy_marketplace.json";
...
const STRATEGY_PUBKEY = new PublicKey(process.env.NEXT_PUBLIC_STRATEGY_PUBKEY || "So11111111111111111111111111111111111111112");
